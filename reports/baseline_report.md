...
- **pass@1 = 0.8857** CI95 (0.8108, 0.9334)  |  pass^1=0.8857 | pass^2=0.8476 | pass^3=0.8286
- policy_violation_rate = **0.0**  |  unnecessary_handoff_rate = 0.0  |  escalation_precision = 1.0
- avg_turns = 2.314  |  p95_latency = 12.495s  |  cost/task = $0.001699
- error taxonomy: {'tool_selection_error': 12, 'missing_param_no_clarify': 1}
- total usage: {'calls': 306, 'prompt_tokens': 551818, 'completion_tokens': 56799, 'cost_usd': 0.178365}
...
|---|---|---|---|---|---|---|---|---|---|---|---|---|---|---|---|---|---|---|---|---|---|---|---|---|---|---|---|---|---|---|---|---|---|---|
| 3/3 | 1/3 | 0/3 | 3/3 | 3/3 | 3/3 | 3/3 | 3/3 | 3/3 | 3/3 | 3/3 | 0/3 | 3/3 | 2/3 | 2/3 | 3/3 | 3/3 | 3/3 | 3/3 | 3/3 | 3/3 | 3/3 | 3/3 | 3/3 | 3/3 | 3/3 | 3/3 | 3/3 | 3/3 | 3/3 | 3/3 | 3/3 | 3/3 | 3/3 | 1/3 |
